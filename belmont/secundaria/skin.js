...
// Pano2VR 5.2.2/15983
// Filename: simplex_v5_secundaria.ggsk
// Generated vie. ago. 10 18:15:04 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._thumbs_barra.ggVisible=false;
		...
		this._dropdown_cloner.onclick=function (e) {
			me._dropdown_menu_title_background.onclick();
		}
		...
		this._dropdown_menu_title.ggUpdateText=function() {
			var hs="<b>Secundaria: <\/b>"+me.ggUserdata.title;
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		this._tt_google.onclick=function (e) {
			me.player.openUrl("https:\/\/goo.gl\/6LeUzH","_blank");
		}
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_node') {
			...
			this._tooltip_drop_shadow.ggUpdateText=function() {
